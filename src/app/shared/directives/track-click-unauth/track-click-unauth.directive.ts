...
import { PublicLogsService } from '../../services/public-logs/public-logs.service';

@Directive({
  selector: '[appTrackClickUnauth]',
  providers: [{ provide: TrackService, useClass: PublicLogsService }]
})
export class TrackClickUnauthDirective {
  @Input()
  dataToTrack: any = {};
