...
describe('RuleCardComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    ruleSpy = jasmine.createSpyObj('rule',{}, {
      title: 'testTitle',
  ...
  it('should render properly', () => {
    ...
    expect(imgEl.attributes.src).toContain('assets/img/financial-education/shared-financial-education/rule-card/circle.svg');
    expect(iconEl.attributes.src).toContain('assets/img/financial-education/shared-financial-education/rule-card/next.svg');
