  ...
  template: `
    <ion-header>
      <ion-toolbar color="uxprimary" class="ux_toolbar">
        ...
        <ion-title>{{ 'apikeys.insert_secret.header' | translate }}</ion-title>
      </ion-toolbar>
    </ion-header>
    <ion-content class="ion-padding">
      <form [formGroup]="this.form" (ngSubmit)="this.handleSubmit()" class="ux_main">
        <div class="ux_content">
          <div class="ik__title">
            <app-ux-title>{{ 'apikeys.insert_secret.title' | translate }}</app-ux-title>
          </div>
          ...
          <div class="ik__ak_input">
            <app-ux-input
              ...
              [placeholder]="'apikeys.insert_secret.insert_secret_placeholder' | translate"
            ></app-ux-input>
          </div>
          <div class="ik__alert">
...
export class InsertSecretPage implements OnInit {
  ...
  handleSubmit() {
    if (this.form.valid) {
      this.apiApikeys.crud.create({ ...this.form.value, ...this.apiKeyData }).subscribe(
        () => this.success(),
        () => this.error()
      );
    } else {
