        ...
        <div class="ion-padding">
          ...
          <ion-card *ngFor="let run of fundRuns">
            ...
            <ion-card-content>
              ...
              <ion-row>
                <ion-col
                  >{{ 'funds.fund_runs.days_title' | translate }}:</ion-col
                >
              ...
              <ion-row>
                <ion-col
                  >{{ 'funds.fund_runs.gain_title' | translate }}:</ion-col
                >
                <ion-col>{{ run.ganancia }}%</ion-col>
              </ion-row>
              <ion-row>
                <ion-col
                  >{{ 'funds.fund_runs.loss_title' | translate }}:</ion-col
                >
              ...
              <ion-row *ngIf="run.porcentaje_ganancia">
                ...
                ><ion-col
                  ><ion-badge
                    ...
                    >{{
                      run.porcentaje_ganancia | number: '1.2-2'
                    }}
                    %</ion-badge
                  ></ion-col
                >
