  ...
  template: `
    <div class="fl__total">
      ...
      >
        ...
        <ion-text>
          {{
            this.totalBalanceBTC?.total_balance
              | number: '1.2-6'
      ...
      <div
        class="fl__total__amount"
        *ngIf="totalBalanceUSDT?.start_balance != 0"
      >
        <div
        ...
        >
          ...
          <ion-text *ngIf="totalBalanceUSDT">
            ≈
            {{
              this.totalBalanceUSDT?.total_balance
                | number: '1.2-6'
                | hideText: this.hideFundText
            }}
