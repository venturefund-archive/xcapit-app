...
@Component({
  ...
  template: `
    <div class="fl__total">
      ...
      <div
        *ngIf="totalBalanceBTC?.start_balance === 0"
      ...
      <div class="fl__total__amount" *ngIf="totalBalanceUSDT?.start_balance !== 0">
        <div class="fl__total__amount ux-font-gilroy ux-fweight-extrabold ux-fweight-regular ux-fsize-17">
      ...
      <div class="fl__total__detail" *ngIf="totalBalanceBTC?.start_balance !== 0">
        ...
        <div class="fl__total__detail__text ux-font-lato ux-fweight-regular ux-fsize-12">
          <ion-text>
