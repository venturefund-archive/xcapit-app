                      ...
                      <div class="ux-card">
                          <div class="ux-card__amount">
                              ...
                              <div class="ux-card__amount__info">
                                  <div>
                                      {{ 'fiat_ramps.ramp_initial.amount_min' | translate }} <span
                                          class="ux-card__amount__info__description"> 200 ARS</span>
                                  </div>
                                  <div>
                                      {{ 'fiat_ramps.ramp_initial.amount_max' | translate }} <span
                                          class="ux-card__amount__info__description"> 250.000 ARS</span>
                                  </div>
                              </div>
                          </div>
