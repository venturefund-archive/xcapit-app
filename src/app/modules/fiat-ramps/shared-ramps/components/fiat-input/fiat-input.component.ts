...
@Component({
  ...
  <div class="fi__amount-select">
        <div class="fi__amount-select__qty-label">
          <ion-label class="ux-font-titulo-xs fi__amount-select__qty-label__base">{{
        ...
        <div class="fi__amount-select__inputs">
          <div class="fi__amount-select__inputs__amount">
            <ion-input appNumberInput [formControlName]="this.formControlName" type="number" inputmode="numeric"> </ion-input>
          </div>
        </div>
        <ion-text class="ux-font-text-xs fi__amount-select__usd-disclaimer">{{
