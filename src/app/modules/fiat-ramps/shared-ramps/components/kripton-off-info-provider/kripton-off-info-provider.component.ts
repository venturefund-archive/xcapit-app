...
@Component({
  selector: 'app-kripton-off-info-provider',
  template: `
    <div>
        ...
        <div class="main__body__content">
          ...
          <div class="main__body__content__title">
            <ion-text class="ux-font-text-xl"
              >{{ 'fiat_ramps.select_provider.modal_info.kripton_sell.provider_name' | translate }}
            </ion-text>
          </div>
          <div class="ux-text-base main__body__content__header">
            <ion-text>{{ 'fiat_ramps.select_provider.modal_info.kripton_sell.header' | translate }}</ion-text>
          </div>
            ...
            <ul>
              <li>
                <ion-text class="ux-font-text-base">
                  {{ 'fiat_ramps.select_provider.modal_info.kripton_sell.minimum_amount' | translate }}
                </ion-text>
              </li>
              <li>
                <ion-text class="ux-font-text-base">
                  {{ 'fiat_ramps.select_provider.modal_info.kripton_sell.delivery_time_1' | translate }}
                </ion-text>
              </li>
            </ul>
          </div>
  ...
  `,
  styleUrls: ['./kripton-off-info-provider.component.scss'],
})
export class KriptonOffInfoProviderComponent implements OnInit {
