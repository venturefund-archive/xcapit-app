...
describe('BankInfoCardComponent', () => {
  ...
  it('should copy amount when ux_copy_amount button is clicked', async() => {
  ...
  it('should copy amount when ux_copy_concept button is clicked', async() => {
  ...
  it('should copy amount when ux_copy_extra button is clicked', async() => {
