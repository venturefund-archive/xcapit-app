    ...
    <form [formGroup]="this.form" (ngSubmit)="this.handleSubmit()" class="ux_main">
      <div *ngIf="!this.isReset">
        <app-ux-title class="ion-padding-top ion-margin-top">
          <div class="ion-margin-top">
            {{ 'users.reset_password.title' | translate }}
          </div>
        </app-ux-title>

        <app-ux-text>
          <div class="ux-font-text-xs ion-margin-top ion-margin-bottom">
            {{ 'users.reset_password.text_before' | translate }}
          </div>
        </app-ux-text>
        ...
        <app-ux-input
          controlName="email"
          type="email"
          [label]="'users.reset_password.title_email' | translate"
          [placeholder]="'users.reset_password.email_placeholder_label' | translate"
          inputmode="email"
      ...
      <div *ngIf="this.isReset">
        ...
        <app-ux-input
          ...
          type="password"
          [label]="'users.reset_password_form.repeat_new_password' | translate"
          inputmode="password"
