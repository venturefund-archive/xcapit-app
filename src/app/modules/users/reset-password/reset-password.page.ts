...
import { ResetPasswordFormComponent } from '../shared-users/components/reset-password-form/reset-password-form.component';
      ...
      <app-reset-password-form [isReset]="this.isReset" (send)="this.handleSubmit($event)">
        <div class="submit-button">
          <div class="ion-padding-top">
            ...
            >
              {{ 'users.reset_password.reset_button' | translate }}
            </ion-button>
            ...
            <ion-button
              *ngIf="this.isReset"
              ...
              [disabled]="this.submitButtonService.isDisabled | async"
            >
              {{ 'users.reset_password.send_email_button' | translate }}
            </ion-button>
          </div>
        </div>
