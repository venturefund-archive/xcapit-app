...
import { ChooseInvestorProfileSkeletonComponent } from './components/defi-investment-product/choose-investor-profile-card-skeleton/choose-investor-profile-skeleton.component';
@NgModule({
  declarations: [
