...
export class WCConnectionV2 {
  ...
  //   console.log(signClient.sessions());
  //   signClient.events().forEach((event) => signClient.removeListener(event));

  //   // signClient.off('session_delete');

  //   this.peerMetadata = undefined;
  //   this.setConnected(false);
  //   // this.setUri(null);

  //   if (this.isConnected) await this.closeSession(); // TODO: aca iba un kill session, cerrarla es igual?

  //   // TODO: COmo guardamos sessiones?
