...
import { ContractInterface, ethers, Wallet, providers } from 'ethers';
...
const testRpc = 'https://public-node.testnet.rsk.co';
...
describe('EthersService', () => {
  ...
  it('should return created provider when newProvider is called with an RPC URL', async () => {
    const provider = await service.newProvider(testRpc);
