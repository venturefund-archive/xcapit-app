...
import { AssetHistoryCacheService, BalanceOrPrice, CachedCoin } from './asset-history-cache.service';
...
describe('AssetHistoryCacheService', () => {
  let service: AssetHistoryCacheService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(AssetHistoryCacheService);
  });
