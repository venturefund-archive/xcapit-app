   ...
   <div class="dip">
      <div class="dip__content">
        <div class="dip__content__title_and_image">
          ...
          <div class="dip__title_container">   
            <ion-text class="ux-font-text-lg">{{
              this.defiProduct.symbol
            }}</ion-text>
            <div class="dip__content__title">
              <ion-text class="ux-font-text-xs title">{{ this.defiProduct.value }}</ion-text>
            </div>
          </div>
        </div>
        <div class="dip__content__performance">
          ...
          <ion-badge class="ux-font-num-subtitulo ux_badge_coming dip__footer__badge" slot="end">{{
            'wallets.shared_wallets.defi_investment_product.annual' | translate 
          }}</ion-badge>
        </div>
        <div class="dip__content__liquidity">
          <div class="dip__content__liquidity__liq">
            <ion-text
              ...
              >{{'wallets.shared_wallets.defi_investment_product.liquidity' | translate}}</ion-text
            >
          </div>
          <div class="dip__content__liquidity__liq">
            <ion-text
              class="ux-font-text-xxs"
              >{{ this.defiProduct.liquidity }} USD</ion-text
            >
          </div>
        </div>
      </div>
      <div class="dip__footer">
        ...
        <div class="dip__footer__button ">
          <ion-button
            *ngIf="!this.defiProduct.isComming"
            appTrackClick
            name="Invest"
            type="button"
          ...
          <ion-badge *ngIf="this.defiProduct.isComming" class="ux-font-num-subtitulo ux_badge_coming ipc__footer__badge" slot="end">{{
            'wallets.shared_wallets.defi_investment_product.comming_badge' | translate
          }}</ion-badge>
        </div>
      </div>
    </div>
