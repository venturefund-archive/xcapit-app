...
describe('ProfilesHelperService', () => {
  ...
  it('shoud call get on apiProfilesService.profileValid when isProfileDataOk', async (done) => {
  ...
  it('isProfileDataOk shoud return true when profileValid return { valid: true }', () => {
  ...
  it('isProfileDataOk shoud return false when profileValid return { valid: false }', () => {
