  ...
  template: `
    ...
    <ion-content class="ion-padding">
      ...
      <h2 class="ion-text-center">
        {{ 'tutorials.ca_tutorial_modal.t2' | translate }}
      </h2>
      <p>
      ...
      <img src="assets/img/tutorials/ca/ca-tutorial-img-1.png" />
      <p>
      ...
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-2.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p8' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-3.png"></ion-img>
      <p>{{ 'tutorials.ca_tutorial_modal.p9' | translate }}</p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-4.png"></ion-img>
      <p class="tutorial__notes">
      ...
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-5.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p13' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-6.png"></ion-img>
      <p>{{ 'tutorials.ca_tutorial_modal.p14' | translate }}</p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-7.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p15' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-8.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p16' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-9.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p17' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-10.png"></ion-img>
      <p>
      ...
      <p>
        ...
        <a href="https://bitex.la" target="_blank" rel="noopener noreferrer">
          https://www.bitex.la <ion-icon name="open"></ion-icon>
        </a>
      </p>
      <p>
      ...
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-11.png"></ion-img>
      <p>{{ 'tutorials.ca_tutorial_modal.p25' | translate }}</p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-12.png"></ion-img>
      <p>{{ 'tutorials.ca_tutorial_modal.p26' | translate }}</p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-13.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p27' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-14.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p28' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-15.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p29' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-16.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p30' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-17.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p31' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-18.png"></ion-img>
      <p>{{ 'tutorials.ca_tutorial_modal.p32' | translate }}</p>

      <hr />

      <h2 class="ion-text-center">
        {{ 'tutorials.ca_tutorial_modal.t4' | translate }}
      </h2>
      <p class="ion-text-center">
        {{ 'tutorials.ca_tutorial_modal.p33' | translate }}
      </p>
      <p>{{ 'tutorials.ca_tutorial_modal.p34' | translate }}</p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-19.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p35' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-20.png"></ion-img>
      <p>
        {{ 'tutorials.ca_tutorial_modal.p36' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-21.png"></ion-img>
      <p class="tutorial__notes">
        {{ 'tutorials.ca_tutorial_modal.p37' | translate }}
      </p>
      <ion-img src="assets/img/tutorials/ca/ca-tutorial-img-22.png"></ion-img>
      <p>
