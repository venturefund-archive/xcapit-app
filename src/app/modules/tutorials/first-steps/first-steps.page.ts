              ...
              <ion-slide>
                  <div class="fs__content_slide">
                      ...
                      <div class="fs__content_slide__slide_step_show"
                           *ngIf="this.userStatus?.status_name !== this.userStatusEnum.FROM_BOT">
                      ...
                      <div class="fs__content_slide__button_next">
                          <ion-button
                                  ...
                                  expand="block"
                                  color="uxsecondary"
                                  (click)="this.userStatus?.status_name !== this.userStatusEnum.FROM_BOT ? this.slideNext() : this.goToEditProfile()"
                          >
...
export class FirstStepsPage implements OnInit {
  ...
  constructor(private router: Router, private apiUsuarios: ApiUsuariosService, private loadingService: LoadingService) {
  }
